...
def musica_partida():
    ...
    pygame.mixer.music.load('./codigo/songs/musica_partida.mp3')
    pygame.mixer.music.set_volume(0.25)
    pygame.mixer.music.play(-1)

def inicio_partida():
    pygame.mixer.music.stop()
    pygame.mixer.music.load('./codigo/songs/inicio_partida.wav')
    pygame.mixer.music.set_volume(0.35)
    pygame.mixer.music.play(1)

def musica_menu():
    pygame.mixer.music.stop()
    pygame.mixer.music.load('./codigo/songs/musica_menu.mp3')
    pygame.mixer.music.set_volume(0.25)
    pygame.mixer.music.play(-1)
