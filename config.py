...
carro_pos_x = 555
carro_pos_y = 556
car_pos_x = randrange(355,555, 100)
car_pos_y_inicial = randint(-2000, -1000)
car_pos_y = randint(-500, -200)
pedra_pos_x = randrange(660, 760, 100)
pedra_pos_y = randint(-1400, -1100)
buraco_pos_x = randrange(355, 455, 100)
buraco_pos_y = randint(-1100,-900)
tronco_pos_x = randrange(660, 760, 100)
tronco_pos_x_inicial = -120
tronco_pos_y = randint(-800, -400)
moeda_pos_x = randrange(460, 560, 100)
moeda_pos_y = randint(-1500, -1250)
rua_numero = 0
