...
carro_pos_x = 555
carro_pos_y = 556
car_pos_x = randrange(355,755, 100)
car_pos_y_inicial = randint(-2000, -1000)
car_pos_y = randint(-600, -300)
pedra_pos_x = randrange(360, 760, 100)
pedra_pos_y = randint(-1000, -700)
buraco_pos_x = randrange(355, 755, 100)
buraco_pos_y = randint(-1500,-1100)
moeda_pos_x = randrange(360, 760, 100)
moeda_pos_y = randint(-500, -120)
rua_numero = 0
